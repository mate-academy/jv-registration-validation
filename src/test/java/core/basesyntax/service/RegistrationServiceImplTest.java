...
class RegistrationServiceImplTest {
    ...
    void register_userNullValue_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(null));
    }

    @Test
    void register_userExists_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("ValidUser01", "valid_password01", 18)));
    }
    @Test
    void register_loginNullValue_notOk() {
      assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User(null, "123456", 18)));
    }

    @Test
    void register_loginShort_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("", "123456", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Ada", "123456", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adam", "123456", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adame", "123456", 18)));
    }
    @Test
    ...
    void register_passwordNullValue_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", null, 18)));
    }

    @Test
    void register_passwordShort_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "1", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123", 18)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "1234", 18)));
    }
    @Test
    void register_passwordShort_edgeCase_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "12345", 18)));
    }
    @Test
    ...
    void register_passwordMoreThanMinLen_Ok() throws RegistrationServiceImplException {
        ...
        assertEquals(expected3, registrationService.register(new User("Adamelo9", "123456789", 18)));
    }
    @Test
    void register_ageNullValue_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123456", null)));
    }
    @Test
    void register_ageNegative_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123456", -1)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123456", -7)));
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123456", -15)));
    }
    @Test
    ...
    void register_ageOfUserUnder18_edgeCase_notOk() {
        assertThrows(RegistrationServiceImplException.class, () -> registrationService.register(new User("Adamelo", "123456", 17)));
    }
