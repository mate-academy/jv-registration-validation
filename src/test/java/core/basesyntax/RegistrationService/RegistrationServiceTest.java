...
class RegistrationServiceTest {
    ...
    void setup() {
        ...
        user3 = new User("KitPes", "fgsdf284254567", 32);
    }
    ...
    void register_addUserWithSameLogin_notOk() {
        ...
        people.add(user3);
        assertThrows(InvalidDataException.class, () -> {
            registrationService.register(new User(user1.getLogin(), "fdyfgas", 18));
        });
        assertThrows(InvalidDataException.class, () -> {
    ...
    @Test
    void register_addUserShortPassword_notOk() {
    ...
    @Test
    void register_addUserShortLogin_notOk() {
