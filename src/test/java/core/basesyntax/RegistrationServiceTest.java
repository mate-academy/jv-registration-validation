...
public class RegistrationServiceTest {
    ...
    @Test
    void register_ShortLogin_ExceptionThrown() {
        user.setLogin("short");
        assertThrows(RegistrationException.class, () -> registrationService.register(user));
    }
    ...
    @Test
    void register_AgeNull_ExceptionThrown() {
        user.setAge(null);
        assertThrows(RegistrationException.class, () -> registrationService.register(user));
    }

    @Test
    void register_PasswordLessThanSix_ExceptionThrown() {
        user.setPassword("12345");
        assertThrows(RegistrationException.class, () -> registrationService.register(user));
    }

    @Test
    void register_UnderageUser_ExceptionThrown() {
        user.setAge(17);
        assertThrows(RegistrationException.class, () -> registrationService.register(user));
    }

    @Test
    void register_ExistingUser_ExceptionThrown() {
