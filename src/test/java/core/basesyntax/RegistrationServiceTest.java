...
public class RegistrationServiceTest {
    ...
    public void registerUserUnderagedUNotOkey() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,() -> {service.register(user1);});
    ...
    public void registerUserSameLoginNotOkey() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,() -> {service.register(user1);service.register(user2);});
