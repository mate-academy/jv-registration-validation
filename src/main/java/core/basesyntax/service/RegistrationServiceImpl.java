...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    private static final String AGE_MESSAGE = "User's age must be at least " + MIN_AGE + "!";
    private static final String LOGIN_LENGTH_MESSAGE = "User's login length"
            + " must be at least " + MIN_LENGTH + " symbols!";
    ...
    private void validate(User user) throws InvalidDataException {
