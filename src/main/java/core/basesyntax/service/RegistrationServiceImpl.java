...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    private static final String USER_PASSWORD_IS_NULL = "User password %s can`t be null";
    ...
    private void checkIsUserValid(User user) {
        ...
        if (Objects.isNull(user.getPassword())) {
            throw new UserRegistrationException(String.format(USER_PASSWORD_IS_NULL, user.getPassword()));
        }
